...
document.write('<scr'+'ipt type="text/javascript" src="https://maps.googleapis.com/maps/api/js?key=AIzaSyD-UKSb-p2SmlJ0KtunL5DFpCukEm5JHXQ" ></scr'+'ipt>');
        ...
        $(this).each(function() {
            ...
            var $this = $(this);
                ...
                if (options.styles) {
                    ...
                    var mapType = new google.maps.StyledMapType(eval(options.styles + MIDNIGHT_style), { name: options.styles });
